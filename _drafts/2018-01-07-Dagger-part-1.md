...
---
تعرفنا في [الجزء الأول](https://mibrahimdev.github.io/dependency-injection/)  على نمط Dependency Injection وأهميته وكيف يمكن عن طريقه الفصل بين ما يعتمد عليه الكلاس، وبين كيفية صناعته .. في هذه التدوينة سنقوم بإختبار النمط في أندرويد وكيف سيسهل عملية التطوير فيما بعد.   
